...
package com.afzaln.downcalc.utils;
...
public class ActionBarHelperBase extends ActionBarHelper {
    ...
    private void setupActionBar() {
        ...
        homeItem.setIcon(R.drawable.ab_icon);
...
//        }
     ...
     * {@link com.afzaln.downcalc.utils.ActionBarHelperBase#setRefreshActionItemState(boolean)}.
     */
    private View addActionItemCompatFromMenuItem(final MenuItem item) {
        ...
        if (itemId == R.id.menu_ok) {
            actionButton.setId(R.id.actionbar_compat_item_ok);
        }
